...
def answer(client,ground_truth,client2,args,question,options_str,document):
...
def test_llm_performance(args,client,client2):
    ...
    for item in data:   
        ...
        if depth in args.test_depth_list and token_lengths in args.test_doc_length:
            ...
            if is_api_based:
                acc = answer(client,ground_truth,client2,args,question,options_str,document)
            else:
